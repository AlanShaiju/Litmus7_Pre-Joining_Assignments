...
public class UserRegistrationController {
	...
	public Response addUser(String username, String password, String email, int age) {
		try {
			if (username == "")
				...
				return Response.success(SUCCESS_CODE, service.addUser(username, password, email, age), null);
	...
	public Response getUserData() {
		try {
			return Response.success(SUCCESS_CODE, "User data retrieved", service.getUserData());
		} catch (Exception e) {
			return Response.failure(FAILURE_CODE, e.getMessage(), null);
		}
	}
